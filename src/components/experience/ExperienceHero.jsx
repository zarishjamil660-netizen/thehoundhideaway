      ...
      <div className="experience-hero__top">
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 pb-32 pt-6 md:px-8 md:pb-44 md:pt-10 lg:px-12">
          <div className="mx-auto max-w-4xl text-center">
            <p
              className="translate-y-14 text-end pr-12 text-3xl font-normal leading-snug [font-family:Franie,var(--font-sans)] tracking-[-0.01em] text-[var(--thh-forest-deep)] md:translate-y-16 md:pr-20 md:text-5xl lg:translate-y-20 lg:pr-28 lg:text-6xl"
            ...
            <h1
              className="mt-4 [font-family:var(--font-serif)] text-[clamp(7.35rem,25vw,19.25rem)] font-medium leading-[0.82] tracking-[-0.01em] text-[var(--thh-forest-deep)]"
              data-experience-reveal
          ...
          <div
            className="experience-hero__media mx-auto w-full max-w-2xl"
            data-experience-reveal="image"
            style={{ '--experience-delay': '360ms' }}
          >
            <img src={imageSrc} alt={imageAlt} className="experience-hero__art relative z-10" decoding="async" />
          </div>
        </div>
      </div>
